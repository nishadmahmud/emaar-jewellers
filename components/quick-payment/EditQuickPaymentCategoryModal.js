...
export default function EditQuickPaymentCategoryModal({ open, category, onClose, onSuccess }) {
  ...
  useEffect(() => {
    if (category) {
      setFormData({
        ...
        transaction_category: category.transaction_category || 'Quick Payment',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || 'Failed to update payment category.');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-white rounded-2xl max-w-md w-full overflow-hidden shadow-xl border border-neutral-200 flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 border-b border-neutral-100 flex items-center justify-between bg-neutral-50/50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-base text-neutral-900">Edit Payment Category</h3>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="e.g. Utility, Transfer..."
