...
export default function ViewCategoryModal({ open, category, onClose }) {
      ...
      <div className="bg-white rounded-2xl max-w-md w-full overflow-hidden shadow-xl border border-neutral-200 flex flex-col">
        ...
        <div className="px-6 py-4 border-b border-neutral-100 flex items-center justify-between bg-neutral-50/50">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="font-bold text-base text-neutral-900">Category Details</h3>
              <p className="text-xs text-neutral-500">Expense Category #{category.id}</p>
            </div>
          </div>
          <button
            type="button"
