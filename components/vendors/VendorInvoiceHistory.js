                ...
                {invoices.map((inv, idx) => {
                  ...
                  return (
                    <tr key={idx} className="hover:bg-neutral-50/50 transition-colors">
                      ...
                      <td className="py-3 px-4 text-right font-semibold">৳ {formatBDT(totalAmt)}</td>
                      <td className="py-3 px-4 text-right text-emerald-600 font-semibold">৳ {formatBDT(paidAmt)}</td>
                      <td className="py-3 px-4 text-right text-rose-600 font-extrabold">৳ {formatBDT(dueAmt)}</td>
